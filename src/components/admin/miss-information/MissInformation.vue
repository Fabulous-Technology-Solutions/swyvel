...
const drafts = reactive([
  {
    ...
    img: 'https://images.unsplash.com/photo-1723903819053-6dc02cbccaf2?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
